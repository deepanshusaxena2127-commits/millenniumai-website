...
import { Twitter, Linkedin, Github, Mail, ShieldCheck, MapPin } from 'lucide-react';

const Footer = () => {
  const currentYear = new Date().getFullYear();
  const LOGO_URL = "https://horizons-cdn.hostinger.com/c99918c0-b1b7-4786-81d6-2c876c6d4f20/d0720f64e456d1b0b5e94dbed03e8ed5.png";
  ...
  const footerLinks = {
    ...
    company: [
      ...
      { name: 'Security', path: '/company/security-data-protection' },
  ...
  const socialLinks = [
    ...
    { icon: Mail, href: 'mailto:info@millenniumai.com', label: 'Email' },
  ];
  ...
  <span className="text-xl font-semibold tracking-wide">
    MillenniumAI
            ...
            <p className="text-slate-400 mb-8 max-w-sm leading-relaxed text-base">
              MillenniumAi provides the enterprise-grade data infrastructure and engineering services that power the world's most advanced AI systems. Trusted by Global 2000 enterprises for quality, security, and scale.
            </p>
            ...
            <div className="space-y-3 text-slate-400">
               <div className="flex items-start gap-3">
                 ...
                 <span>UGF 02 Krishna Enclave, Govindpuram, Ghaziabad, Uttar Pradesh 201002, India</span>
               </div>
               <div className="flex flex-col gap-2">
                 ...
                 <div className="flex items-center gap-3">
                   <Mail size={16} className="text-blue-500 flex-shrink-0" />
                   <a href="mailto:hr@millenniumai.in" className="hover:text-white transition-colors">hr@millenniumai.in</a>
                 </div>
               </div>
            </div>
          </div>
          ...
          <div className="lg:col-span-2">
            <h4 className="text-white font-semibold mb-6 text-base">Solutions</h4>
            <ul className="space-y-4">
              {footerLinks.solutions.map((link) => (
                <li key={link.name}>
                  <Link to={link.path} className="text-slate-400 hover:text-blue-400 transition-colors block">
                    {link.name}
                  </Link>
                </li>
              ))}
          ...
          <div className="lg:col-span-2">
            <h4 className="text-white font-semibold mb-6 text-base">Industries</h4>
            <ul className="space-y-4">
          ...
          <div className="lg:col-span-2">
           ...
           <div className="lg:col-span-2">
            <h4 className="text-white font-semibold mb-6 text-base">Insights</h4>
            <ul className="space-y-4">
        ...
        <div className="pt-8 border-t border-white/10 flex flex-col md:flex-row justify-between items-center gap-6">
          <p className="text-slate-500 text-sm">
            &copy; {currentYear} MillenniumAi Inc. All rights reserved.
          </p>
          <div className="flex items-center gap-8 text-sm text-slate-500 font-medium">
             <div className="flex items-center gap-2 text-green-500/90 bg-green-500/10 px-3 py-1 rounded-full border border-green-500/20">
               <ShieldCheck size={14} /> 
               <span>ISO27001 || Certified</span>
             </div>
             <Link to="/company/security-data-protection" className="hover:text-white transition-colors">Privacy Policy</Link>
             <Link to="/company/security-data-protection" className="hover:text-white transition-colors">Terms of Service</Link>
          </div>
        </div>
      </div>
    </footer>
