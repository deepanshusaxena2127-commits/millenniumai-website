...
const ToastViewport = React.forwardRef(({ className, ...props }, ref) => (
  <ToastPrimitives.Viewport
    ref={ref}
    className={cn(
      'fixed z-[100] flex max-h-screen w-full flex-col-reverse p-4 sm:top-6 sm:right-6 sm:bottom-auto sm:left-auto sm:flex-col md:max-w-[420px]',
      className
    )}
    {...props}
  />
    ...
    'motion-reduce:transition-none motion-reduce:animate-none',
  {
    variants: {
      variant: {
        ...
        destructive:
          'border-destructive bg-destructive text-destructive-foreground group-[.destructive]:border-destructive',
        success:
